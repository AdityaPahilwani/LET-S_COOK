...
const tabScreenConfig={
    Meals:{
            ...
            navigationOptions:{
                tabBarIcon:(tabInfo)=>{
                 return( <Entypo   name='home' size={23}
                  color={Color.accent} />);
                },tabBarColor:Color.lgdark,
                tabBarLabel:Platform.OS==='android'?<Text style={{fontSize:hp('2%'),color:Color.text2 }}>Home</Text>:<Text>Home</Text>
            }
            
        },
        add:{
            screen:AddRecipeScreen,navigationOptions:{
                tabBarIcon:(tabInfo)=>{
                 return( 
                  <MaterialIcons name='add-circle' size={23}
                  color={Color.accent} />);
                },tabBarColor:Color.lgdark,
                tabBarLabel:Platform.OS==='android'?<Text style={{fontSize:hp('2%'),color:Color.text2 }}>Add</Text>:<Text>Add</Text>
            }
        },
        Fav:{
            screen:FavNav,
            navigationOptions:{
            tabBarIcon:(tabInfo)=>{
                return (<AntDesign name="heart" size={23} color={Color.accent} />);
                },tabBarColor:Color.lgdark,
                tabBarLabel:Platform.OS==='android'?<Text style={{fontSize:hp('2%'),color:Color.text2 }}>Favorites</Text>:<Text>Favorites</Text>
            }
        },
        ProfileOverView : {
            ...
            tabBarIcon:(tabInfo)=>{
                ...
                tabBarLabel:Platform.OS==='android'?<Text style={{fontSize:hp('2%'),color:Color.text2 }}>user</Text>:<Text>user</Text>
            }
        },
